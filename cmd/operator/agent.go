...
var agentCmd = &cobra.Command{
  ...
  Run: func(cmd *cobra.Command, args []string) {
    ...
    _ = eventHandler.Listen(context.TODO(), channel, clusterId)
    //}()
    //go func() {
...
func init() {
  ...
  agentCmd.Flags().String("channel", "ClusterChannel", "The socket channel to connect to")
  agentCmd.Flags().Int("cluster-id", 0, "The cluster ID to subscribe to")
